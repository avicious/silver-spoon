...
Welcome to Silver Spoon! This is a popular multi-cuisine restaurant known for its delicious food and quick delivery. They offer home delivery, catering, and have multiple locations. It serves as a key piece of my portfolio, demonstrating my skills in building robust, performant, and user-friendly web applications with Next.js.
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/avicious/silver-spoon.git
    cd silver-spoon
    ```
